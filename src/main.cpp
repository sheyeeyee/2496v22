...
imuTurn(45);
delay(5);
drive(29); //originally 25
delay(1000);
moveLift(-900);
delay(15);
moveLift(900);
delay(5);
drive(13);//originally 10
delay(5);
drive(-15);//originally -20
delay(5);
moveLift(-1000);
delay(5);
// drive(18);
...
//half awp for right with shelley setup
// drive(18);
// delay(5);
// moveLift(-900);
// delay(15);
...
//idk brain help-? not sure what this does kay kay
...
//Skills ? the one that was being edited 11/2
// 	moveLift(-1980);
// 	delay(5);
//   stop_lift();
// 	drive(20);
// 	delay(5);
//   moveMogo(1700);
// 	//liftMobileGoal(); // put mogo into rack *adjust values cuz it overshoots goal rn*
// 	delay(5);
// 	drive(-5);
// 	delay(5);
...
// 	delay(5);
//   reset_lift();
// 	moveLift(-1200); //values from here are guesstimated?
// 	delay(5);
// 	drive(230); //push neutral into opposite side
//   delay(5);
//   imuTurn(90);
//   delay(5);
//   drive(-35);
...
//   imuTurn(-90);
//   delay(5);
//   drive(-200); //push alliance goal into correct home zone
//   delay(5);
//   imuTurn(90);
//   delay(5);
//   driveLiftDown(250, -1880); //go for alliance goal
//   delay(5);
//   moveLift(1000);
//   delay(5);
//   imuTurn(-90);
...
//   delay(5);
//   drive(50);
//   while(true) autoBalance(); //does this work?
// //}
...
void opcontrol() {
  ...
  // if(localTime % 50 == 0) {con.print(0,0, "Pitch: %.2f", imu.get_pitch());}
    ...
    con.print(0,0, "mid Right: %.2f", RM.get_encoder_units());
